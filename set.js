...
global.caption = "*©𝟐𝟎𝟐𝟒 𝐁𝐄𝐀 𝐃𝐈𝐄 🦋*"; // Input Yours custom...(Maintain font for Flow)
...
global.footer = "*ᴘᴏᴡᴇʀᴇᴅ ʙʏ ɴɪᴢᴢᴜ ɪᴅ ꜱᴇᴠᴇʀ*"; // Input Yours custom...(Maintain font for Flow)
 
module.exports = {
SESSION_ID: process.env.SESSION_ID || "Gifted~i7By2bAT#APwjDQRioll-D5lnP1RFf-LwmqiEqbvTRTb5ypcqSAM", // Add sess Id here espwcially when deploying on panels else use app.json and .env file...
...
OWNER_NAME: process.env.OWNER_NAME || "𝐍𝐈𝐙𝐙𝐔  𝐃𝐈𝐄 🪦🧿", // Input Yours custom...(Maintain font for Flow)
PACK_AUTHOR: process.env.PACK_AUTHOR || "𝐍𝐢𝐳𝐳𝐳", // Added // Input Yours custom...
PACK_NAME: process.env.PACK_NAME || "𝐍𝐢𝐱𝐳𝐳", // Added // Input Yours custom...
...
BOT_NAME: process.env.BOT_NAME || "𝐍𝐈𝐙𝐙𝐔 . 𝐃𝐈𝐄 🪦🧿", // Input Yours custom...(Maintain font for Flow)
